...
export class EmployeeSearchComponent implements OnInit {
  ...
  empType
  modalRef: BsModalRef;
  displayedColumns: string[] = ['employee_code', 'first_name', 'mobile', 'identity_card_number', 'insurance_number', 'address', 'allocateTo', 'removeAllocation'];
  ...
  openDialog(employee): void {
    ...
    const dialogRef = this.dialog.open(DeletePopupComponent, {
      width: '250px',
      data: { name: employee.first_name, id: employee.employee_id,process:'Delete' }
    });
